            ...
            createElementVNode("div", _hoisted_4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.codeValues, (val, index) => {
                return (openBlock(), createElementBlock("input", {
                  ...
                  type: "text",
                  maxlength: "1",
                  class: normalizeClass(["avue-input__code-item", { 'is-disabled': _ctx.disabled }]),
                  value: val,
                  disabled: _ctx.disabled,
                  readonly: _ctx.readonly,
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.ipSegments, (seg, index) => {
                    return (openBlock(), createElementBlock(Fragment, { key: index }, [
                      createElementVNode("input", {
                        type: "text",
                        class: normalizeClass(["avue-input__ip-segment", { 'is-disabled': _ctx.disabled }]),
                        maxlength: "3",
                        value: seg,
                        disabled: _ctx.disabled,
                        readonly: _ctx.readonly,
                  ...
                  createElementVNode("div", _hoisted_10, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.macSegments, (seg, index) => {
                      return (openBlock(), createElementBlock(Fragment, { key: index }, [
                        createElementVNode("input", {
                          type: "text",
                          class: normalizeClass(["avue-input__mac-segment", { 'is-disabled': _ctx.disabled }]),
                          maxlength: "2",
                          value: seg,
                          disabled: _ctx.disabled,
                          readonly: _ctx.readonly,
