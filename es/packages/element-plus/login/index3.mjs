...
import { resolveComponent, openBlock, createElementBlock, normalizeStyle, normalizeClass, createVNode, withKeys, withCtx, createBlock, createCommentVNode, createTextVNode, toDisplayString, createElementVNode, renderSlot } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createVNode(_component_el_form, {
      ...
      "label-suffix": ":",
      onKeyup: withKeys(_ctx.onSubmit, ["enter"])
    }, {
      default: withCtx(() => [
        (!_ctx.username.hide)
                        ...
                        (_ctx.isPhone)
                          ...
                          : (_ctx.isImg)
                            ? (openBlock(), createElementBlock("button", {
                                key: 1,
                                type: "button",
                                class: normalizeClass(_ctx.b('captcha')),
                                disabled: _ctx.disabled || _ctx.loading,
                                "aria-label": "刷新验证码",
        ...
        createVNode(_component_el_form_item, {
          ...
          default: withCtx(() => [
            createVNode(_component_el_button, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(_ctx.submitText), 1 /* TEXT */)
              ]),
              _: 1 /* STABLE */
            }, 8 /* PROPS */, ["class", "disabled", "loading", "onClick"])
          ]),
        ...
        renderSlot(_ctx.$slots, "footer", { form: _ctx.form })
      ]),
      _: 3 /* FORWARDED */
