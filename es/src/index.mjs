...
export { default as Captcha } from '../packages/element-plus/captcha/index2.mjs';
...
export { default as FileManager } from '../packages/element-plus/file-manager/index2.mjs';
export { default as FilterBuilder } from '../packages/element-plus/filter-builder/index2.mjs';
