...
const getRowDicRequests = (columns = [], rows = [], childrenKey = src_global_variable.DIC_PROPS.children) => {
        ...
        list.forEach((form) => {
            rowColumns.forEach((column) => {
                ...
                requests.push({
                    ...
                    empty: values.some(src_utils_validate.validatenull),
                });
            });
...
exports.getRowDicRequests = getRowDicRequests;
exports.isRowDicColumn = isRowDicColumn;
