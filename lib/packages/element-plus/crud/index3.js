...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_el_icon_circle_check_filled = vue.resolveComponent("el-icon-circle-check-filled");
      ...
      default: vue.withCtx(() => [
        ...
        (_ctx.validData(_ctx.tableOption.tip, _ctx.config.tip) && _ctx.tableOption.selection)
          ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: vue.normalizeClass(_ctx.b('tip')),
              role: "status",
              "aria-live": "polite"
            }, [
              vue.createElementVNode("div", {
                class: vue.normalizeClass(_ctx.b('tip-content'))
              }, [
                vue.createVNode(_component_el_icon_circle_check_filled, {
                  class: vue.normalizeClass(_ctx.b('tip-icon')),
                  "aria-hidden": "true"
                }, null, 8 /* PROPS */, ["class"]),
                vue.createElementVNode("span", {
                  class: vue.normalizeClass(_ctx.b('tip-name'))
                }, vue.toDisplayString(_ctx.t("crud.tipStartTitle")), 3 /* TEXT, CLASS */),
                vue.createElementVNode("span", {
                  class: vue.normalizeClass(_ctx.b('tip-count'))
                }, vue.toDisplayString(_ctx.selectLen), 3 /* TEXT, CLASS */),
                vue.createElementVNode("span", {
                  class: vue.normalizeClass(_ctx.b('tip-suffix'))
                }, vue.toDisplayString(_ctx.t("crud.tipEndTitle")), 3 /* TEXT, CLASS */)
              ], 2 /* CLASS */),
              vue.createElementVNode("div", {
                class: vue.normalizeClass(_ctx.b('tip-actions'))
              }, [
                ...
                (_ctx.selectLen > 0)
                  ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                      ...
                      class: vue.normalizeClass(_ctx.b('tip-button')),
                      size: _ctx.size,
                      onClick: _ctx.clearSelection
                    }, {
                      default: vue.withCtx(() => [
                        vue.createTextVNode(vue.toDisplayString(_ctx.t("crud.emptyBtn")), 1 /* TEXT */)
                      ]),
                      _: 1 /* STABLE */
