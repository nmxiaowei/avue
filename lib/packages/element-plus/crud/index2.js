...
require('./menu/table-page.js');
require('./menu/header-search.js');
require('./menu/header-menu.js');
require('./dialog/dialog-column.js');
require('./dialog/dialog-filter.js');
require('./dialog/dialog-form.js');
require('./dialog/dialog-excel.js');
require('./column/column.js');
require('./column/column-menu.js');
require('./column/column-default.js');
var packages_elementPlus_crud_config = require('./config.js');
var src_core_columnState = require('../../../src/core/column-state.js');
...
var dialogExcel_vue_vue_type_script_lang = require('./dialog/dialog-excel2.js');
var dialogForm_vue_vue_type_script_lang = require('./dialog/dialog-form2.js');
var dialogFilter_vue_vue_type_script_lang = require('./dialog/dialog-filter2.js');
var dialogColumn_vue_vue_type_script_lang = require('./dialog/dialog-column2.js');
var headerMenu_vue_vue_type_script_lang = require('./menu/header-menu2.js');
var headerSearch_vue_vue_type_script_lang = require('./menu/header-search2.js');
var tablePage_vue_vue_type_script_lang = require('./menu/table-page2.js');
var columnMenu_vue_vue_type_script_lang = require('./column/column-menu2.js');
var columnDefault_vue_vue_type_script_lang = require('./column/column-default2.js');
var column_vue_vue_type_script_lang = require('./column/column2.js');
var item_vue_vue_type_script_lang = require('./grid/item2.js');
var index_vue_vue_type_script_lang = require('./grid/index2.js');

var script = src_core_create.default({
  name: "crud",
  mixins: [packages_core_common_init.default("crud"), src_core_locale.default],
  emits: [
    "update:modelValue",
    "tree-load",
    "selection-clear",
  ...
  components: {
    tableCard: index_vue_vue_type_script_lang.default,
    tableItemCard: item_vue_vue_type_script_lang.default,
    column: column_vue_vue_type_script_lang.default,
    columnDefault: columnDefault_vue_vue_type_script_lang.default, //其它列,
    columnMenu: columnMenu_vue_vue_type_script_lang.default, //操作栏，
    tablePage: tablePage_vue_vue_type_script_lang.default, //分页
    headerSearch: headerSearch_vue_vue_type_script_lang.default, //搜索
    headerMenu: headerMenu_vue_vue_type_script_lang.default, //菜单头部
    dialogColumn: dialogColumn_vue_vue_type_script_lang.default, //显隐列
    dialogFilter: dialogFilter_vue_vue_type_script_lang.default, //过滤器
    dialogForm: dialogForm_vue_vue_type_script_lang.default, //分页
    dialogExcel: dialogExcel_vue_vue_type_script_lang.default, //导出
  },
  data() {
    return {
      reload: Math.random(),
  ...
  computed: {
    ...
    rowParentKey() {
      return this.option.rowParentKey || src_global_variable.DIC_PROPS.rowParentKey;
    },
    childrenKey() {
      return this.treeProps.children || src_global_variable.DIC_PROPS.children;
    },
    hasChildrenKey() {
      return this.treeProps.hasChildren || src_global_variable.DIC_PROPS.hasChildren;
    },
    treeProps() {
    ...
    propOption() {
      ...
      result = src_core_dataformat.calcCascader(result);
      return result;
    },
    isShowSummary() {
    ...
    columnOption() {
      return src_utils_util.getColumn(this.tableOption.column);
    },
    columnStateKey() {
      return (
  ...
  methods: {
    ...
    restoreColumnState() {
      ...
      const state =
        typeof loader === "function"
          ...
          : src_core_columnState.loadColumnState(this.columnStateKey, this.columnStateStorage);
      if (!state) return;
      this.tableOption.column = src_core_columnState.applyColumnState(this.tableOption.column, state);
    },
    saveColumnState(reason = "change") {
      ...
      const state = src_core_columnState.createColumnState(this.columnOption);
      const saver = this.tableOption.columnStateSave;
      if (typeof saver === "function") {
        saver(state, this.columnStateKey, reason, this.tableOption);
      } else {
        src_core_columnState.saveColumnState(this.columnStateKey, state, this.columnStateStorage);
      }
    ...
    resetColumnState(callback) {
      ...
      if (typeof remover === "function") {
        ...
        src_core_columnState.removeColumnState(this.columnStateKey, this.columnStateStorage);
      }
    ...
    getBtnIcon(value) {
      ...
      return this.tableOption[name]
        ...
        : packages_elementPlus_crud_config.default[name];
    },
    //对部分表单字段进行校验的方法
    ...
    rowCellAdd(row = {}) {
      ...
      let formDefault = src_core_dataformat.formInitVal(this.propOption);
      row = this.deepClone(
        Object.assign(
          {
            $cellEdit: true,
    ...
    tableDrop(type, el, callback) {
      ...
      return window.Sortable.create(el, {
        ghostClass: packages_elementPlus_crud_config.default.ghostClass,
        chosenClass: packages_elementPlus_crud_config.default.ghostClass,
        animation: 100,
        delay: 100,
