...
var script = src_core_create.default({
  ...
  computed: {
    ...
    leafKey () {
      return this.props.leaf || src_global_variable.DIC_PROPS.leaf
    },
    valueKey () {
      return this.props.value || src_global_variable.DIC_PROPS.value;
    },
    labelKey () {
      return this.props.label || src_global_variable.DIC_PROPS.label;
    },
    childrenKey () {
      return this.props.children || src_global_variable.DIC_PROPS.children;
    },
    nodeKey () {
      return this.option.nodeKey || src_global_variable.DIC_PROPS.nodeKey;
    },
    defaultExpandAll () {
