    ...
    methods: {
      ...
      updateData: function updateData() {
        ...
        var callback = function callback() {
          _this2.key = false;
          if (_this2.isApi) {
            var dataUrl = _this2.dataUrl.replace('${HOME_URL}', _this2.homeUrl);
            var detail = function detail(res) {
              var data = typeof _this2.dataFormatter === 'function' ? _this2.dataFormatter(res.data) : res.data;
              var result = data.data || {};
              if (_this2.dataAppend) {
                var _loop = function _loop(i) {
                  if (i === result.length - 1) {
                    _this2.propQuery.datetime = result[i][_this2.datetime];
                  }
                  _this2.dataCount++;
                  setTimeout(function () {
                    _this2.dataChart.unshift(result[i]);
                  }, _this2.dataCount * 1500);
                };
            ...
            if (_this2.dataMethod === 'get') {
              _this2.$httpajax.get(dataUrl, {
                params: Object.assign(_this2.dataQuery, _this2.propQuery)
              }).then(function (res) {
                detail(res);
              });
            } else if (_this2.dataMethod === 'post') {
              var params = {};
              var url = dataUrl;
              if (url.includes("?")) {
                var index = url.indexOf("?");
              ...
              _this2.$httpajax.post(dataUrl, Object.assign(_this2.dataQuery, params, _this2.propQuery)).then(function (res) {
                detail(res);
              });
            }
          } else {
        ...
        this.$nextTick(function () {
          ...
          if (_this2.time !== 0 && _this2.disabled) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b1674402_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(362);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b1674402_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
