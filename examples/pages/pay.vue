  ...
  <div class="pay">
    ...
    <div class="pay__x">
      ...
      <p class="pay__x-list">
        ...
        8.提供工作流，多租户，系统设置，用户管理等常用开发模版</br>
        9.底层更加完善的开发错误调试机制，轻量级的自动构建脚手架上手更容易</br>
        10.更多组件一键配置即可生成</br>
        11.详细的开发文档和源码讲解文档</br>
        12.购买后可用于商业化开发，永久更新授权使用</br>
        13.更多彩蛋等着你。。。</br>
      </p>
      <p>发布时间：2019-01-01</p>
      <p>售价：999（现购企业版全家桶套餐，avuex将免费升级），avue开源版将持续更新维护。</p>
    </div>
    <fieldset>
