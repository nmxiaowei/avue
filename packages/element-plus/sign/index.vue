<template>
  <div :class="[b(), { 'is-disabled': isDisabled }]" :style="styleName">
    <div v-if="title || showToolbar || $slots.header" :class="b('header')">
      <slot name="header">
        <div v-if="title" :class="b('title')">{{ title }}</div>
        <div :class="b('status')">{{ statusText }}</div>
      </slot>
      <div v-if="showToolbar" :class="b('tools')">
        <button
          type="button"
          :class="b('clear')"
    ...
    <div :class="b('surface')" :style="surfaceStyle">
      <canvas
        ref="canvas"
        :class="b('canvas')"
        :width="canvasWidth"
      ...
      ></canvas>
      <span v-if="isEmpty" :class="b('placeholder')">{{ placeholder }}</span>
    </div>
    <div v-if="$slots.footer" :class="b('footer')"><slot name="footer"></slot></div>
  </div>
</template>
